...
|| (sessionTable == 'meiti' && scope.row.meitiId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xinwenliumeitipingtai/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.meitiId = el.meitiId;//---
                            forum.meitiName = el.meitiName;
                            forum.meitiPhoto = el.meitiPhoto;
                            forum.meitiPhone = el.meitiPhone;
                            forum.meitiEmail = el.meitiEmail;
                            forum.meitiDelete = el.meitiDelete;
                            forum.createTime = el.createTime;
