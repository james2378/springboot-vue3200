<template>
    <div style="backgroundImage: url('/xinwenliumeitipingtai/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">新闻流媒体平台注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="媒体姓名" class="input" v-if="tableName=='meiti'">
                            <el-input v-model="ruleForm.meitiName" autocomplete="off" placeholder="媒体姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='meiti'">
                            <el-input v-model="ruleForm.meitiPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='meiti'">
                            <el-input v-model="ruleForm.meitiEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.meitiName)&& 'meiti'==this.tableName){
                                this.$message.error('媒体姓名不能为空');
                                return
                            }
                             if('meiti' == this.tableName && this.ruleForm.meitiPhone&&(!this.$validate.isMobile(this.ruleForm.meitiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('meiti' == this.tableName && this.ruleForm.meitiEmail&&(!this.$validate.isEmail(this.ruleForm.meitiEmail))){
